                        ...
                        <div className="space-y-6 justify-center">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:oumaima0@fazani@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">oumaima0fazani@gmail.com</a>
                                </div>
                            </div>
                        </div>
                        <div className="space-y-6 justify-center">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+21654259484" className="text-muted-foreground hover:text-primary transition-colors">+216 54 259 484</a>
                                </div>
                            </div>
                        </div>
                        <div className="space-y-6 justify-center">
